...
const drawFive = () => {
    axios.get('http://54.215.22.105/api/robots/five')
        .then(res => {
...
const duel = () => {
    ...
    setTimeout(() => {
        axios.post('http://54.215.22.105/api/duel', {compDuo, playerDuo})
            .then(({data}) => {
...
const getPlayerStats = () => {
    axios.get('http://54.215.22.105/api/player')
...
const getAllBots = () => {
    axios.get('http://54.215.22.105/api/robots')
        .then(({data}) => {
